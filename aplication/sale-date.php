...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/nav.css">
	<link rel="stylesheet" type="text/css" href="css/sale_date.css">
...
<body>
  <nav>
    ...
    <div class="date_select">
      <form method="POST">  
        <input type="date" name="from_period" id="from_period">
        <input type="date" name="to_period" id="to_period">
        <input class="submit" type="submit" name="submit" value="AFIȘEAZĂ">
      </form>
    </div>
    ...
    <?php
      ...
      if(isset($_POST['submit'])):
        $from_period = date('Y-m-d', strtotime($_POST['from_period']));
        $to_period = date('Y-m-d', strtotime($_POST['to_period']));
    ?>
      <table id="myTable">
        <thead>
          <tr>
        ...
        <tbody>
          <?php
            while($row = $result->fetch_assoc()):
              if ($row['data'] >= $from_period && $row['data'] <= $to_period):
          ?>
